...
function clearForm() {
    let clearTitle = $("#txtTitle").val('');
    let clearDescription = $("#txtDescription").val('');
    let clearLocation = $("#txtLocation").val('');
    let clearDueDate = $("#selDueDate").val('');
    let clearcategory = $("#selCategory").val('');
    let clearColor = $("#selColor").val('');
}
